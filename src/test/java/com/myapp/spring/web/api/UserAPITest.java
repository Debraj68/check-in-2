...
public class UserAPITest {
	...
	public void testGetsByPnr() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/products/{pnr}",123))
	...
	@Test
	@DisplayName("Test All Users By BaggageWeight /api/v1/products/{baggageWeight}")
	...
	@Test
	@DisplayName("Test All Users By Pnr /api/v1/products?pnr=&email")
